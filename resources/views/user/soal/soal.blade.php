...
<body>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Waktu keseluruhan</li>
        <li class="breadcrumb-item active" aria-current="page">Sesi 1</li>
    </ol>
    </nav>
    </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function jawab(idJawaban) {
            ...
            var idPelamar = '{{session('nik')}}';
            $.get("{{url('update-jawaban')}}",{
                id_soal: idSoal,
