                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title" style="margin-top:5px;"><i class="fas fa-list-ul"></i> Daftar Soal
                            </h3>
                            <div class="card-tools">
                                <a href="{{route('soal.create')}}" class="btn btn-sm btn-info float-right">
                                    <i class="fas fa-plus"></i> Tambah Soal</a>
                            </div>
                        </div>
                        <div class="card-body">
...
<script>
    $(document).ready(function () {
        ...
        $('#tbl thead tr:eq(1) th').each( function (i) {
            var title = $(this).text();
            if(title == 'Jenis Soal' || title == 'Pertanyaan') {
