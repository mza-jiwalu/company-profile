...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Sub Departemen</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Sub Departemen</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title" style="margin-top:5px;"><i class="fas fa-list-ul"></i> Daftar Sub Departemen
                            </h3>
                            <div class="card-tools">
                                <a href="{{route('sub-departemen.create')}}" class="btn btn-sm btn-info float-right">
                                    <i class="fas fa-plus"></i> Tambah Sub Departemen</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <table id="tbl" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$no}}</td>
                                        <td>{{$subDepartemen->departemen}}</td>
                                        <td>{{$subDepartemen->name}}</td>
                                        <td>{{$subDepartemen->detail}}</td>
                                        <td align="center">
                                            <form action="{{route('sub-departemen.destroy', $subDepartemen->id)}}" method="post">
                                                @csrf
                                                <a href="{{route('sub-departemen.edit', $subDepartemen->id)}}"
