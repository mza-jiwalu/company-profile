            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('jumlah-truck.index')}}">Truck</a></li>
            ...
            <div class="row">
                <div class="col">
                    <div class="card card-primary">
                        ...
                        <form action="{{route('jumlah-truck.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                            <div class="card-body">
                                ...
                                <label for="isi">Jumlah</label>
                                    <input type="number" class="form-control" name="total_truk" id="cover" required>
                                </div>
                            </div>
                            <!-- /.card-body -->
