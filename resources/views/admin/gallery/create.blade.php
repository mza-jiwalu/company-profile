...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Tambah Gallery</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title" style="margin-top:5px;"><i class="fas fa-list-ul"></i> Tambah Gallery
                            </h3>
                        ...
                        @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group video">
                                    ...
                                    <input type="text" class="form-control" name="path" placeholder="Link video">
                                </div>
                            </div>
                            <!-- /.card-body -->
