            ...
            <div class="row">
                <div class="col">
                    <div class="card card-primary">
                        ...
                        <form action="{{route('ritase.update', $ritase->id)}}" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="_method" value="PUT">
                        @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="isi">Tahun</label>
                                    <input type="number" class="form-control" value="{{$ritase->tahun}}" name="tahun" id="cover" required>
                                </div>
                                <div class="form-group">
                                <label for="isi">Jumlah</label>
                                    <input type="number" class="form-control" value="{{$ritase->jumlah}}" name="jumlah" id="cover" required>
                                </div>
                            </div>
                            <!-- /.card-body -->
