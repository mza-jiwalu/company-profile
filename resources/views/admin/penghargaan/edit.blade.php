                        ...
                        @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$penghargaan->judul}}" id="judul" name="judul"
                                        placeholder="Masukkan judul" required>
                                </div>
                                <div class="form-group">
                                    <label for="isi">Deskripsi</label>
                                    <textarea id="summernote" name="deskripsi">{!! $penghargaan->deskripsi !!}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="checkbox" {{($penghargaan->rilis == 1) ? 'checked' : ''}} data-bootstrap-switch data-off-color="danger"
