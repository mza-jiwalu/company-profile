                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title" style="margin-top:5px;"><i class="fas fa-list-ul"></i> Daftar
                                Penghargaan
                            </h3>
                            <div class="card-tools">
                                <a href="{{route('penghargaan.create')}}" class="btn btn-sm btn-info float-right">
                                    <i class="fas fa-plus"></i> Tambah Penghargaan</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <table id="tblPenghargaan" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th>Judul</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">{{$penghargaan->updated_at}}</td>
                                        <td align="center">
                                            <span
                                                class="badge {{ ($penghargaan->rilis == 1) ? 'bg-success' : 'bg-danger' }}">{{ ($penghargaan->rilis == 'on') ? 'ON' : 'OFF' }}</span>
                                        </td>
                                        <td align="center">
                                            <?php $no=1; ?>
                                            <form action="{{route('penghargaan.destroy', $penghargaan->id)}}"
                                                method="post" class="float-right">
                                            <a href="{{route('penghargaan.show', $penghargaan->id)}}"
                                                class="btn btn-xs btn-info" title="Detail"><i class="fa fa-eye"></i>
                                                Detail</a>
