...
!function(e, t, s) {
    ...
    e.fn.hideseek = function(t) {
        ...
        return this.each(function() {
            var s = e(this);
            s.opts = [], e.map(["list", "nodata", "attribute", "highlight", "ignore", "headers", "navigation", "ignore_accents", "hidden_mode"], function(e, i) {
            ...
            s.opts.navigation && s.attr("autocomplete", "off"), s.opts.hidden_mode && i.children().hide(), s.keyup(function(t) {
                ...
                if (38 != t.keyCode && 40 != t.keyCode && 13 != t.keyCode) {
                    var r = s.val().toLowerCase();
                    i.children(s.opts.ignore.trim() ? ":not(" + s.opts.ignore + ")" : "").removeClass("selected").each(function() {
                        var t = "text" != s.opts.attribute ? e(this).attr(s.opts.attribute).toLowerCase() : e(this).text().toLowerCase(),
                            i = -1 == t.removeAccents(s.opts.ignore_accents).indexOf(r) || r === (s.opts.hidden_mode ? "" : !1);
                        i ? (e(this).hide(), s.trigger("_after_each")) : (s.opts.highlight ? e(this).removeHighlight().highlight(r).show() : e(this).show(), s.trigger("_after_each"))
                    }), s.opts.nodata && (i.find(".no-results").remove(), i.children(':not([style*="display: none"])').length || i.children().first().clone().removeHighlight().addClass("no-results").show().prependTo(s.opts.list).text(s.opts.nodata)), s.opts.headers && e(s.opts.headers, i).each(function() {
